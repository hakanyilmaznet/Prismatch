    ...
    <div class="cardx">
      <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
        ...
        <div class="links">
          ...
          <a class="btn btn-outline-secondary" href="privacy.php"><?= h(L('privacy')) ?></a>
        </div>
      </div>
    </div>

    <div class="cardx">
      <div class="pre"><?= h(L('intro', ['google' => $google])) ?></div>
      <h2><?= h(L('s1')) ?></h2>
      <div class="pre"><?= h(L('s1_body', ['google' => $google])) ?></div>
      <h2><?= h(L('s2')) ?></h2>
      <div class="pre"><?= h(L('s2_body')) ?></div>
      <h2><?= h(L('s3')) ?></h2>
      <div class="pre"><?= h(L('s3_body', ['google' => $google])) ?></div>
      <h2><?= h(L('s4')) ?></h2>
